...
function cakifo_theme_setup() {
	...
	require_once( trailingslashit( THEME_DIR ) . 'functions/template-general.php' );
	require_once( trailingslashit( THEME_DIR ) . 'functions/template-post.php' );
	require_once( trailingslashit( THEME_DIR ) . 'functions/template-media.php' );
	...
	add_theme_support( 'loop-pagination' ); // not used since 1.7.0
 ...
 *
 * 1) Adds two button classes to the submit button
 *
 * @since Cakifo 1.7.0
 * @param array $args
 * @return array
