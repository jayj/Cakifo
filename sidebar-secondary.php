 ...
 * widgets screen in the admin by the user.
 *
 * @package Cakifo
 * @subpackage Template
 */
...
if ( is_active_sidebar( 'secondary' ) ) : ?>
	...
	<?php do_atomic( 'before_sidebar_secondary' ); ?>

	<aside id="sidebar-secondary" class="sidebar-secondary widget-area">

		<?php do_atomic( 'open_sidebar_secondary' );  ?>

		<?php dynamic_sidebar( 'secondary' ); ?>

		<?php do_atomic( 'close_sidebar_secondary' ); ?>

	</aside> <!-- .sidebar-secondary -->

	<?php do_atomic( 'after_sidebar_secondary' ); ?>
