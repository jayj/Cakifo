...
<article id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
	...
	<?php if ( is_singular() ) : ?>
		...
		<header class="entry-header">
			...
			<?php echo apply_atomic_shortcode( 'byline_video', '<div class="byline">' . __( 'Published on [entry-published] by [entry-author] [entry-edit-link before=" | "]', 'cakifo' ) . '</div>' ); ?>
	...
	<?php else : ?>
		...
		<footer class="entry-meta">
			<?php echo apply_atomic_shortcode( 'entry_meta_video', __( '[post-format-link] published on [entry-published] by [entry-author] [entry-comments-link before="| "] [entry-edit-link before=" | "]', 'cakifo' ) ); ?>
		</footer> <!-- .entry-meta -->
